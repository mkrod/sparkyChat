...
import { acceptUserRequest, cancelSentRequest, declineUserRequest, sendFriendRequest } from "../controllers/friends/friends.controller.js";
...
router.put("/add/user", sendFriendRequest);
