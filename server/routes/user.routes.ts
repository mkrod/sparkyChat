...
import { acceptUserRequest, cancelSentRequest, countFriendsRequest, declineUserRequest, fetchAllUserRequests, fetchUserFriends, removeUserAsFriend, sendFriendRequest } from "../controllers/friends/friends.controller.js";
...
router.get("/requests/count", countFriendsRequest);
